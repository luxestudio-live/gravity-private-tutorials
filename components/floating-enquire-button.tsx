  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Main button */}
        <div className="relative flex items-center gap-3 bg-gradient-to-r from-primary via-secondary to-primary bg-size-200 animate-gradient px-6 py-4 rounded-full shadow-2xl hover:shadow-primary/50 transition-all duration-300 hover:scale-110">
